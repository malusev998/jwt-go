...
func Parse(tokenString string, keyFunc Keyfunc, options ...ParserOptions) (*Token, error) {
	return NewParser(options...).Parse(tokenString, keyFunc)
}

// ParseWithClaims is Parse, but with a specified Claims type
func ParseWithClaims(tokenString string, claims Claims, keyFunc Keyfunc, options ...ParserOptions) (*Token, error) {
